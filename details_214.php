	...
	<body>
		...
		<center>
			<div style="background-color:white;color:#4a595b;text-align:left;padding:20px;position:relative;top:30px;width:80%;">
				...
				<br>
				<center>
					<div  class='p_title'>二業</div>
				</center>
                <?php 
					//平班資料表命名為vidchu_19_215_項目
					echo "<br>";
				...
				//上午外掃
					...
					while($row=mysqli_fetch_assoc($result3)){
                        ...
                        if($row["vidchu_11_214_leaves"]=="加分"){
                            echo"落葉&ensp;";
                        }
					...
					echo "</td>
						...
						while($row=mysqli_fetch_assoc($result5)){
                            ...
                            if($row["vidchu_11_214_leaves"]=="扣分"){
                                echo"落葉&ensp;";
                            }
					...
					echo  "</td>
						<td>";
					$get101_4="SELECT vidchu_11_214_remark FROM vidchu_11_am_score";
					$result4=mysqli_query($db_link,$get101_4) or die('新增失敗2');
					while ($row = mysqli_fetch_array($result4, MYSQLI_ASSOC)) {
						echo $row["vidchu_11_214_remark"];
					}
					echo "</td>
						</tr>";
					echo "</center>";
				...
				//下午外掃
					...
					echo  "</td>
						<td>";
					$get101_11="SELECT vidchu_11_214_remark FROM vidchu_11_pm_score";
