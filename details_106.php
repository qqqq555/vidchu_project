			...
			<div style="background-color:white;color:#4a595b;text-align:left;padding:20px;position:relative;top:30px;width:80%;">
				...
				//上午外掃
					echo"<tr>
						<td>上午外掃</td>
						<td>";
					$get101_3="SELECT * FROM vidchu_9_am_score";
					...
					echo "</td>
						<td>";
						$get101_5="SELECT * FROM vidchu_9_am_score";
					...
					echo  "</td>
						<td>";
					$get101_4="SELECT vidchu_9_106_remark FROM vidchu_9_am_score";
				...
				//下午外掃
					echo"<tr>
						<td>下午外掃</td>
						<td>";
					$get101_9="SELECT * FROM vidchu_9_pm_score";
					...
					echo "</td>
						<td>";
						$get101_10="SELECT * FROM vidchu_9_pm_score";
