...
<?php
    ...
    function search(){
        ...
        if($score_search=='第1週'){
            header("location: admin_score_1_1.php");
        }
        else if($score_search=='第2週'){
            header("location: admin_score_1_2.php");
        }
        else if($score_search=='第3週'){
            header("location: admin_score_1_3.php");
        }
        else if($score_search=='第4週'){
            header("location: admin_score_1_4.php");
        }
        else if($score_search=='第5週'){
            header("location: admin_score_1_5.php");
        }
        else if($score_search=='第6週'){
            header("location: admin_score_1_6.php");
        }
        else if($score_search=='第7週'){
            header("location: admin_score_1_7.php");
        }
        else if($score_search=='第8週'){
            header("location: admin_score_1_8.php");
        }
        else if($score_search=='第9週'){
            header("location: admin_score_1_9.php");
        }
        else if($score_search=='第10週'){
            header("location: admin_score_1_10.php");
        }
        else if($score_search=='第11週'){
            header("location: admin_score_1_11.php");
        }
        else if($score_search=='第12週'){
            header("location: admin_score_1_12.php");
        }
        else if($score_search=='第13週'){
            header("location: admin_score_1_13.php");
        }
        else if($score_search=='第14週'){
            header("location: admin_score_1_14.php");
        }
        else if($score_search=='第15週'){
            header("location: admin_score_1_15.php");
        }
        else if($score_search=='第16週'){
            header("location: admin_score_1_16.php");
        }
        else if($score_search=='第17週'){
            header("location: admin_score_1_17.php");
        }
        else if($score_search=='第18週'){
            header("location: admin_score_1_18.php");
        }
        else if($score_search=='第19週'){
            header("location: admin_score_1_19.php");
        }
        else if($score_search=='第20週'){
            header("location: admin_score_1_20.php");
        }
        else if($score_search=='第21週'){
            header("location: admin_score_1_21.php");
        }
        else if($score_search=='第22週'){
            header("location: admin_score_1_22.php");
        }
        else if($score_search=='第23週'){
            header("location: admin_score_1_23.php");
        }
        else if($score_search=='第24週'){
            header("location: admin_score_1_24.php");
        }
        else if($score_search=='第25週'){
            header("location: admin_score_1_25.php");
        }
        else if($score_search=='第26週'){
            header("location: admin_score_1_26.php");
        }
        else if($score_search=='第27週'){
            header("location: admin_score_1_27.php");
        }
        else if($score_search=='第28週'){
            header("location: admin_score_1_28.php");
        }
        else if($score_search=='第29週'){
            header("location: admin_score_1_29.php");
        }
        else if($score_search=='第30週'){
            header("location: admin_score_1_30.php");
        }
    }
?>
<!DOCTYPE HTML>
<html>
    ...
    <body>
        ...
        <div class="container mt-3"> <!--選擇查詢年級週數-->
            ...
            <div class="btn-group">
                <button type="button" onclick="location.href='admin_score_1_1.php'" class="btn btn-secondary active" style="font-size: 25px;">高一</button>
            ...
            <div> <!--成績表格-->
                ...
                $sql_query="SELECT * FROM score_1_25";
