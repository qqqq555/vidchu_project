			...
			<div style="background-color:white;color:#4a595b;text-align:left;padding:20px;position:relative;top:30px;width:80%;">
				...
				//上午外掃
					echo"<tr>
						<td>上午外掃</td>
						<td>";
					$get101_3="SELECT * FROM vidchu_23_score";
					...
					echo "</td>
						<td>";
						$get101_5="SELECT * FROM vidchu_23_score";
						$result5=mysqli_query($db_link,$get101_5) or die('新增失敗3');
						while($row=mysqli_fetch_assoc($result5)){
							if($row["vidchu_23_102_litter"]=="扣分"){
								echo"人為垃圾&ensp;";
							}
							if($row["vidchu_23_102_leaves"]=="扣分"){
								echo"落葉&ensp;";
							}
						}
					echo  "</td>
						<td>";
					$get101_4="SELECT vidchu_23_102_remark FROM vidchu_23_score";
					$result4=mysqli_query($db_link,$get101_4) or die('新增失敗2');
					while ($row = mysqli_fetch_array($result4, MYSQLI_ASSOC)) {
						echo $row["vidchu_23_102_remark"];
					}
					echo "</td> 
						</tr>";
					echo "</center>";
