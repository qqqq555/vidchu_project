			...
			<div style="background-color:white;color:#4a595b;text-align:left;padding:20px;position:relative;top:30px;width:80%;">
				...
				//上午內掃
					echo"<tr>
						<td>上午內掃</td>
						<td>";
					$get101_1="SELECT * FROM vidchu_21_am_score";
					...
					echo "</td>
						<td>";
						$get101_6="SELECT * FROM vidchu_21_am_score";
				...
				//上午外掃
					...
					echo "</td>
						...
						while($row=mysqli_fetch_assoc($result5)){
                            ...
                            if($row["vidchu_5_304_others"]=="扣分"){
                                echo"其他&ensp;";
                            }
						}
					echo  "</td>
						<td>";
					$get101_4="SELECT vidchu_5_304_remark FROM vidchu_5_am_score";
					$result4=mysqli_query($db_link,$get101_4) or die('新增失敗2');
					while ($row = mysqli_fetch_array($result4, MYSQLI_ASSOC)) {
						echo $row["vidchu_5_304_remark"];
					}
					echo "</td>
						</tr>";
					echo "</center>";
				...
				echo"<tr>
						<td>下午內掃</td>
						<td>";
					$get101_7="SELECT * FROM vidchu_21_pm_score";
					...
					echo "</td>
						<td>";
						$get101_8="SELECT * FROM vidchu_21_pm_score";
				...
				//下午外掃
					...
					echo  "</td>
						<td>";
					$get101_11="SELECT vidchu_5_304_remark FROM vidchu_5_pm_score";
