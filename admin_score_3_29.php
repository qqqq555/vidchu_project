...
<?php
    ...
    function search(){
        ...
        if($score_search=='第1週'){
            header("location: admin_score_3_1.php");
        }
        else if($score_search=='第2週'){
            header("location: admin_score_3_2.php");
        }
        else if($score_search=='第3週'){
            header("location: admin_score_3_3.php");
        }
        else if($score_search=='第4週'){
            header("location: admin_score_3_4.php");
        }
        else if($score_search=='第5週'){
            header("location: admin_score_3_5.php");
        }
        else if($score_search=='第6週'){
            header("location: admin_score_3_6.php");
        }
        else if($score_search=='第7週'){
            header("location: admin_score_3_7.php");
        }
        else if($score_search=='第8週'){
            header("location: admin_score_3_8.php");
        }
        else if($score_search=='第9週'){
            header("location: admin_score_3_9.php");
        }
        else if($score_search=='第10週'){
            header("location: admin_score_3_10.php");
        }
        else if($score_search=='第11週'){
            header("location: admin_score_3_11.php");
        }
        else if($score_search=='第12週'){
            header("location: admin_score_3_12.php");
        }
        else if($score_search=='第13週'){
            header("location: admin_score_3_13.php");
        }
        else if($score_search=='第14週'){
            header("location: admin_score_3_14.php");
        }
        else if($score_search=='第15週'){
            header("location: admin_score_3_15.php");
        }
        else if($score_search=='第16週'){
            header("location: admin_score_3_16.php");
        }
        else if($score_search=='第17週'){
            header("location: admin_score_3_17.php");
        }
        else if($score_search=='第18週'){
            header("location: admin_score_3_18.php");
        }
        else if($score_search=='第19週'){
            header("location: admin_score_3_19.php");
        }
        else if($score_search=='第20週'){
            header("location: admin_score_3_20.php");
        }
        else if($score_search=='第21週'){
            header("location: admin_score_3_21.php");
        }
        else if($score_search=='第22週'){
            header("location: admin_score_3_22.php");
        }
        else if($score_search=='第23週'){
            header("location: admin_score_3_23.php");
        }
        else if($score_search=='第24週'){
            header("location: admin_score_3_24.php");
        }
        else if($score_search=='第25週'){
            header("location: admin_score_3_25.php");
        }
        else if($score_search=='第26週'){
            header("location: admin_score_3_26.php");
        }
        else if($score_search=='第27週'){
            header("location: admin_score_3_27.php");
        }
        else if($score_search=='第28週'){
            header("location: admin_score_3_28.php");
        }
        else if($score_search=='第29週'){
            header("location: admin_score_3_29.php");
        }
        else if($score_search=='第30週'){
            header("location: admin_score_3_30.php");
        }
    }
?>
<!DOCTYPE HTML>
    ...
    <body>
        ...
        <div class="container mt-3"> <!--選擇查詢年級週數-->
            ...
            <div class="btn-group">
                ...
                <button type="button" onclick="location.href='admin_score_2_1.php'" class="btn btn-secondary" style="font-size: 25px;">高二</button>
                <button type="button" onclick="location.href='admin_score_3_1.php'" class="btn btn-secondary active" style="font-size: 25px;">高三</button>
            </div>
            &nbsp;&nbsp;
            ...
            <div> <!--成績表格-->
                ...
                $sql_query="SELECT * FROM score_3_29";
