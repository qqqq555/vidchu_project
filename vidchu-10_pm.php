		...
		<div class="wrapper">
			<header>
				...
				<span style="position:absolute;right:5px;top:20px;padding:10px;">
					...
					<span class="line_left"></span>
						<li class="button_css" onclick="location.href='vidchu-10_pm.php'">衛糾評分</li>
						<span class="line_left"></span>
			...
			<center>
				...
				<br>
				<form method="post" action="v_10_pm_handle.php" style="background-color:white;width:100%;right:0;position:relative;top:40px;">
