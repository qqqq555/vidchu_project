			...
			<div style="background-color:white;color:#4a595b;text-align:left;padding:20px;position:relative;top:30px;width:80%;">
				...
				//上午內掃
					echo"<tr>
						<td>上午內掃</td>
						<td>";
					$get101_1="SELECT * FROM vidchu_17_am_score";
					$result1=mysqli_query($db_link,$get101_1);
					while($row=mysqli_fetch_assoc($result1)){
						if($row["vidchu_17_222_A"]=="加分"){
							echo"黑板&ensp;";
						}
						if($row["vidchu_17_222_B"]=="加分"){
							echo"講桌&ensp;";
						}
						if($row["vidchu_17_222_C"]=="加分"){
							echo"窗戶&ensp;";
						}
						if($row["vidchu_17_222_D"]=="加分"){
							echo"蒸飯箱&ensp;";
						}
						if($row["vidchu_17_222_E"]=="加分"){
							echo"資收籃&ensp;";
						}
						if($row["vidchu_17_222_F"]=="加分"){
							echo"垃圾桶&ensp;";
						}
						if($row["vidchu_17_222_G"]=="加分"){
							echo"置物櫃&ensp;";
						}
						if($row["vidchu_17_222_H"]=="加分"){
							echo"地板+走廊";
						}
						if($row["vidchu_17_222_I"]=="加分"){
							echo"餐具";
						}
                    }
					echo "</td>
						<td>";
						$get101_6="SELECT * FROM vidchu_17_am_score";
						$result6=mysqli_query($db_link,$get101_6) or die('新增失敗6');
						while($row=mysqli_fetch_assoc($result6)){
							if($row["vidchu_17_222_A"]=="扣分"){
								echo"黑板&ensp;";
							}
							if($row["vidchu_17_222_B"]=="扣分"){
								echo"講桌&ensp;";
							}
							if($row["vidchu_17_222_C"]=="扣分"){
								echo"窗戶&ensp;";
							}
							if($row["vidchu_17_222_D"]=="扣分"){
								echo"蒸飯箱&ensp;";
							}
							if($row["vidchu_17_222_E"]=="扣分"){
								echo"資收籃&ensp;";
							}
							if($row["vidchu_17_222_F"]=="扣分"){
								echo"垃圾桶&ensp;";
							}
							if($row["vidchu_17_222_G"]=="扣分"){
								echo"置物櫃&ensp;";
							}
							if($row["vidchu_17_222_H"]=="扣分"){
								echo"地板+走廊";
							}
							if($row["vidchu_17_222_I"]=="扣分"){
								echo"餐具";
							}
						}
						echo "</td>";
				...
				//上午外掃
					echo"<tr>
						<td>上午外掃</td>
						<td>";
					$get101_3="SELECT * FROM vidchu_5_am_score";
					...
					echo "</td>
						<td>";
						$get101_5="SELECT * FROM vidchu_5_am_score";
					...
					echo  "</td>
						<td>";
					$get101_4="SELECT vidchu_5_222_remark FROM vidchu_5_am_score";
					$result4=mysqli_query($db_link,$get101_4) or die('新增失敗2');
					while ($row = mysqli_fetch_array($result4, MYSQLI_ASSOC)) {
						echo $row["vidchu_5_222_remark"];
					}
					echo "</td>
						</tr>";
					echo "</center>";
				...
				echo"<tr>
						<td>下午內掃</td>
						<td>";
					$get101_7="SELECT * FROM vidchu_17_pm_score";
					...
					echo "</td>
						<td>";
						$get101_8="SELECT * FROM vidchu_17_pm_score";
				...
				//下午外掃
					echo"<tr>
						<td>下午外掃</td>
						<td>";
					$get101_9="SELECT * FROM vidchu_5_pm_score";
					...
					echo "</td>
						<td>";
						$get101_10="SELECT * FROM vidchu_5_pm_score";
					...
					echo  "</td>
						<td>";
					$get101_11="SELECT vidchu_5_222_remark FROM vidchu_5_pm_score";
