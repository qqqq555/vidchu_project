		...
		<div class="wrapper">
			<header>
				...
				<span style="position:relative;top:20px;padding:10px;float:right;right:20px">
					...
					<span class="line_left"></span>
						<li class="button_css" onclick="location.href='vidchu-2_am.php'">衛糾評分</li>
						<span class="line_left"></span>
			...
			<center>
				...
				<br>
				<form	method="post" action="v_2_am_handle.php" style="background-color:white;width:100%;right:0;position:relative;top:40px;">
