		...
		<div class="wrapper">
			<header>
				...
				<span style="position:absolute;right:5px;top:20px;padding:10px;">
					...
					<span class="line_left"></span>
						<li class="button_css" onclick="location.href='vidchu-19_pm.php'">衛糾評分</li>
						<span class="line_left"></span>
			...
			<center>
				...
				<br>
				<form method="post" action="v_19_pm_handle.php" style="background-color:white;width:100%;right:0;position:relative;top:40px;">
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二仁</legend>
							<label style="color:#4a595b;font-weight:bold;">&ensp;莊敬樓及自強樓2~4F連接通道+自強樓3F語言教室外走廊(含洗手台)+自強樓2F電腦教室外及選修教室外走廊(含洗手台)</label>
							<br>
							<span>&ensp;&ensp;&ensp;&ensp;&ensp;</span>人為垃圾
								<select name="vidchu_19_201_litter" required>
									<option>不加不扣</option>
										<option>扣分</option>
								</select>
								<br>
								<span>&ensp;&ensp;&ensp;&ensp;&ensp;</span>灰塵
								<select name="vidchu_19_201_dust" required>
									<option>不加不扣</option>
										<option>扣分</option>
								</select>
								<br>
								<span>&ensp;&ensp;&ensp;&ensp;&ensp;</span>其他(洗手台)
								<select name="vidchu_19_201_others" required>
									<option>不加不扣</option>
										<option>扣分</option>
								</select>
								<br>
								&ensp;&ensp;&ensp;&ensp;&ensp;扣分備註&ensp;<span style="color:orange;">*扣分必填</span><br>
								&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<textarea name="vidchu_19_201_remark" rows="4" cols="50" placeholder=" ex : 原木平台有衛生紙"></textarea>
								<br>
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二智</legend>
							<span>
								黑板
									<select name="vidchu_19_204_A" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								講桌
									<select name="vidchu_19_204_B" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								窗戶
									<select name="vidchu_19_204_C" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								蒸飯箱
									<select name="vidchu_19_204_D" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								資收籃
									<select name="vidchu_19_204_E" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								垃圾桶
									<select name="vidchu_19_204_F" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								置物櫃
									<select name="vidchu_19_204_G" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								地板+走廊
									<select name="vidchu_19_204_H" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								餐具
									<select name="vidchu_19_204_I" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二忠</legend>
							<span>
								黑板
									<select name="vidchu_19_205_A" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								講桌
									<select name="vidchu_19_205_B" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								窗戶
									<select name="vidchu_19_205_C" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								蒸飯箱
									<select name="vidchu_19_205_D" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								資收籃
									<select name="vidchu_19_205_E" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								垃圾桶
									<select name="vidchu_19_205_F" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								置物櫃
									<select name="vidchu_19_205_G" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								地板+走廊
									<select name="vidchu_19_205_H" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								餐具
									<select name="vidchu_19_205_I" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二敬</legend>
							<span>
								黑板
									<select name="vidchu_19_213_A" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								講桌
									<select name="vidchu_19_213_B" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								窗戶
									<select name="vidchu_19_213_C" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								蒸飯箱
									<select name="vidchu_19_213_D" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								資收籃
									<select name="vidchu_19_213_E" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								垃圾桶
									<select name="vidchu_19_213_F" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								置物櫃
									<select name="vidchu_19_213_G" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								地板+走廊
									<select name="vidchu_19_213_H" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								餐具
									<select name="vidchu_19_213_I" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二業</legend>
							<span>
								黑板
									<select name="vidchu_19_214_A" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								講桌
									<select name="vidchu_19_214_B" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								窗戶
									<select name="vidchu_19_214_C" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								蒸飯箱
									<select name="vidchu_19_214_D" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								資收籃
									<select name="vidchu_19_214_E" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								垃圾桶
									<select name="vidchu_19_214_F" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								置物櫃
									<select name="vidchu_19_214_G" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								地板+走廊
									<select name="vidchu_19_214_H" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								餐具
									<select name="vidchu_19_214_I" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二樂</legend>
							<span>
								黑板
									<select name="vidchu_19_215_A" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								講桌
									<select name="vidchu_19_215_B" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								窗戶
									<select name="vidchu_19_215_C" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								蒸飯箱
									<select name="vidchu_19_215_D" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								資收籃
									<select name="vidchu_19_215_E" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								垃圾桶
									<select name="vidchu_19_215_F" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								置物櫃
									<select name="vidchu_19_215_G" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								地板+走廊
									<select name="vidchu_19_215_H" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								餐具
									<select name="vidchu_19_215_I" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
					...
					<fieldset style="width:60%;position:center;text-align:left;padding:20px;border:4px solid #ffd9e6;border-radius:20px;">
						<legend style="color:#4a595b;font-weight:bold;font-size:20px;">二群</legend>
							<span>
								黑板
									<select name="vidchu_19_216_A" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								講桌
									<select name="vidchu_19_216_B" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								窗戶
									<select name="vidchu_19_216_C" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								蒸飯箱
									<select name="vidchu_19_216_D" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								資收籃
									<select name="vidchu_19_216_E" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								垃圾桶
									<select name="vidchu_19_216_F" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								置物櫃
									<select name="vidchu_19_216_G" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								地板+走廊
									<select name="vidchu_19_216_H" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
								餐具
									<select name="vidchu_19_216_I" required>
										<option>不加不扣</option>
										<option>扣分</option>
									</select>
								<br>
